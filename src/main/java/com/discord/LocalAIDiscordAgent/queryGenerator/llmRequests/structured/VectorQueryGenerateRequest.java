package com.discord.LocalAIDiscordAgent.queryGenerator.llmRequests.structured;
...
public class VectorQueryGenerateRequest extends StructuredLLMRequest {
    ...
    public VectorQueryGenerateRequest(DiscGlobalData discGlobalData) {
