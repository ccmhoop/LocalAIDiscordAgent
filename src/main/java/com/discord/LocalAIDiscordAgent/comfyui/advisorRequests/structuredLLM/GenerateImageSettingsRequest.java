package com.discord.LocalAIDiscordAgent.comfyui.advisorRequests.structuredLLM;
...
public class GenerateImageSettingsRequest extends StructuredLLMRequest {
    ...
    public GenerateImageSettingsRequest(String summary) {
        super(ImageSettingsRecord.class, SYSTEM_MESSAGE, new StructuredLLMContextRecord(
                null,
                null,
                null,
                summary
