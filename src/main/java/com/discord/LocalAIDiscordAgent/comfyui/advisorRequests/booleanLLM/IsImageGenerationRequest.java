package com.discord.LocalAIDiscordAgent.comfyui.advisorRequests.booleanLLM;

import com.discord.LocalAIDiscordAgent.llmAdvisors.booleanLLM.request.BooleanLLMRequest;

public class IsImageGenerationRequest extends BooleanLLMRequest {
    ...
    public IsImageGenerationRequest(){
