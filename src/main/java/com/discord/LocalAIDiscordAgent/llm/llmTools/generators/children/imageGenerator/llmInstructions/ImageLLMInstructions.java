package com.discord.LocalAIDiscordAgent.llm.llmTools.generators.children.imageGenerator.llmInstructions;
...
@Component
public class ImageLLMInstructions extends LLMFileSettingsInstructions<ImageSettingsDTO> {
    ...
    public ImageLLMInstructions() {
        super(ImageSettingsDTO.class, SYSTEM_MESSAGE, USER_INSTRUCT);
    }
