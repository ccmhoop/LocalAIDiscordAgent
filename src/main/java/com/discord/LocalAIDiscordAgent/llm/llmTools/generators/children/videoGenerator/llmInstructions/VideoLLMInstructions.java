package com.discord.LocalAIDiscordAgent.llm.llmTools.generators.children.videoGenerator.llmInstructions;

import com.discord.LocalAIDiscordAgent.llm.llmTools.generators.parent.LLMInstructions.LLMFileSettingsInstructions;
import com.discord.LocalAIDiscordAgent.llm.llmTools.generators.children.videoGenerator.dto.VideoSettingsDTO;
import org.springframework.stereotype.Component;

@Component
public class VideoLLMInstructions extends LLMFileSettingsInstructions<VideoSettingsDTO> {
    ...
    public VideoLLMInstructions() {
        super(VideoSettingsDTO.class, SYSTEM_MESSAGE, USER_INSTRUCT);
    }
