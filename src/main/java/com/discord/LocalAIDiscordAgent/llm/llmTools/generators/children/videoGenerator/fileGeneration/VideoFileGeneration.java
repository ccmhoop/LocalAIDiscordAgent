package com.discord.LocalAIDiscordAgent.llm.llmTools.generators.children.videoGenerator.fileGeneration;
...
@Component
public class VideoFileGeneration {

    private final ObjectMapper objectMapper;
    private final ComfyuiService comfyuiService;

    public VideoFileGeneration(ObjectMapper objectMapper, ComfyuiService comfyuiService) {
        this.objectMapper = objectMapper;
        this.comfyuiService = comfyuiService;
    }

    public Mono<ComfyuiService.GeneratedFile> generateVideoFile(PromptData promptData) {
    ...
    private Map<String, Object> buildWorkflow(PromptData promptData) throws Exception {
        VideoSettingsDTO videoSettings = promptData.getVideoSettings();
    ...
    private void setVideoSettings(Map<String, Object> workflow, VideoSettingsDTO settings) {
