...
public abstract class FileGenerationChainService<T extends Record> {
    ...
    protected Mono<ComfyuiService.GeneratedFile> executeChain(
        ...
        return Mono.fromCallable(() -> {
                    ...
                    T settings = llmInstructionsGenerateSetting(userMessage, "");
    ...
    protected abstract T llmInstructionsGenerateSetting(String userMessage, String context);
