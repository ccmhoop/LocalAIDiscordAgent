package com.discord.LocalAIDiscordAgent.llm.llmTools.generators.children.musicGenerator.llmInstructions;
...
@Component
public class MusicLLMInstructions extends LLMFileSettingsInstructions<MusicSettingsDTO> {
    ...
    public MusicLLMInstructions() {
        super(MusicSettingsDTO.class, SYSTEM_MESSAGE, USER_INSTRUCT);
    }
