package com.discord.LocalAIDiscordAgent.llm.llmTools.webSearch.preparation;

import com.discord.LocalAIDiscordAgent.discord.data.DiscGlobalData;
import com.discord.LocalAIDiscordAgent.llm.llmChains.data.PromptData;
import com.discord.LocalAIDiscordAgent.llm.llmTools.webSearch.llmCall.WebSearchDecisionCall;
import com.discord.LocalAIDiscordAgent.llm.llmTools.webSearch.service.WebSearchRuleEngine;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;

@Slf4j
@Component
public class WebSearchPreparation {

    private final WebSearchDecisionCall necessityService;
    private final WebSearchRuleEngine ruleEngine;

    public WebSearchPreparation(
            WebSearchDecisionCall necessityService,
