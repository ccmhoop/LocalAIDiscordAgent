...
import com.discord.LocalAIDiscordAgent.llm.llmTools.generators.service.FileGeneratorLLMChainService;
...
public class LLMCallChain {
    ...
    private final FileGeneratorLLMChainService fileGeneratorService;
    ...
    public LLMCallChain(
            ...
            MapperUtils mapperUtils, FileGeneratorLLMChainService fileGeneratorService,
    ...
    public Mono<ComfyuiService.GeneratedFile> executeImageChain(DiscGlobalData discGlobalData, boolean requiresContext) {
        return fileGeneratorService.imageGenerationLLMChain(discGlobalData, requiresContext);
    }

    public Mono<ComfyuiService.GeneratedFile> executeVideoChain(DiscGlobalData discGlobalData, boolean requiresContext) {
        return fileGeneratorService.videoGenerationLLMChain(discGlobalData, requiresContext);
    }

    public Mono<ComfyuiService.GeneratedFile> executeMusicChain(DiscGlobalData discGlobalData, boolean requiresContext) {
        return fileGeneratorService.musicGenerationLLMChain(discGlobalData, requiresContext);
    }
