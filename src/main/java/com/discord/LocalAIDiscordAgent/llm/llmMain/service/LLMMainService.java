package com.discord.LocalAIDiscordAgent.llm.llmMain.service;
...
import com.discord.LocalAIDiscordAgent.llm.llmMain.helpers.LLMMainHelpers;
    ...
    public Mono<String> generateLLMResponse(UserEntity userEntity, DiscGlobalData discGlobalData, boolean requiresContext) {
        return Mono.fromCallable(() -> callLLM(discGlobalData, requiresContext))
                ...
                .flatMap(chatResponse -> {
                    ...
                    String assistantMessage = LLMMainHelpers.extractOutputTextAsString(chatResponse);
