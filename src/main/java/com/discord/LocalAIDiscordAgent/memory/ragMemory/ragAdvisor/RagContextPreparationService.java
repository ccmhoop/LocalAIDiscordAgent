...
import com.discord.LocalAIDiscordAgent.memory.ragMemory.webQAMemory.WebQAService;
...
public class RagContextPreparationService {
    ...
    public void prepare(DiscGlobalData discGlobalData, PromptData promptData, boolean requiresContext) {
        if(!requiresContext) {
            return;
        }
