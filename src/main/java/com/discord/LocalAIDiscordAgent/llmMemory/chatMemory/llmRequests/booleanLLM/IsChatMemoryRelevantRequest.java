package com.discord.LocalAIDiscordAgent.llmMemory.chatMemory.llmRequests.booleanLLM;
...
public class IsChatMemoryRelevantRequest extends BooleanLLMRequest {
    ...
    public IsChatMemoryRelevantRequest(DiscGlobalData discGlobalData) {
